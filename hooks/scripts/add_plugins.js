    ...
    _.each(removedPlugins, function (pluginToRemove, key, list) {
      ...
      waterfallFunctions.push(function (callback) {
        ...
        if (pluginToRemove === "cordova-plugin-ionic") {
          pluginToRemove = "https://github.com/deliverymanager/cordova-plugin-ionic.git@stable --variable APP_ID='-' --variable UPDATE_METHOD='none' --variable CHANNEL_NAME='-' --variable WARN_DEBUG='false'";
        }
