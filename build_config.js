    ...
    async.waterfall([
      ...
      function (callback) {
        ...
        s3.upload({
            ...
            ACL: 'public-read',
            Body: (minSdkVersion !== "24" ? fs.createReadStream(groupDirectory + platformAndroidPath + "debug/app-armv7-debug.apk") : fs.createReadStream(groupDirectory + platformAndroidPath + "debug/app-debug.apk"))
          },
          function (err, dataS3) {
            if (err) {
              console.log(err);
