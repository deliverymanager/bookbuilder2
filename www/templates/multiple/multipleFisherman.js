  ...
  .controller("MultipleFishermanController", function ($scope, $ionicPlatform, $rootScope, $timeout, $http, _) {
    ...
    var timeout = $timeout(function () {
        ...
        var imageLoader = new createjs.ImageLoader(new createjs.LoadItem().set({
          src: $scope.rootDir + "data/assets/multipleFisherman_background.png"
        }));
        ...
        imageLoader.on("complete", function (r) {
          ...
          var background = new createjs.Bitmap($scope.rootDir + "data/assets/multipleFisherman_background.png");
                  ...
                  async.waterfall([
                      ...
                      function (questionsAndAnswersCallback) {
                        ...
                        questionBackgroundImageLoader.on("complete", function (r) {
                          ...
                          $scope.questionBackground.x = 95;
                          $scope.questionBackground.y = 40;
                          ...
                          $scope.questionContainer.width = 650;
                          $scope.questionContainer.height = 70;
                          $scope.questionContainer.x = 95;
                          $scope.questionContainer.y = 40;
                      ...
                      function (createPageButtonsAndDescriptionCallback) {
                        $http.get($scope.rootDir + "data/assets/skip_one_answer_button_sprite.json")
                          .success(function (response) {
                            ...
                            $scope.skipAnswerButton.x = 550;
                            $scope.skipAnswerButton.y = 625;
                      ...
                      function (createPageButtonsAndDescriptionCallback) {
                        ...
                        $http.get($scope.rootDir + "data/assets/go_to_results_button_sprite.json")
                          .success(function (response) {
                            ...
                            $scope.goToResultsButton.x = 740;
                            $scope.goToResultsButton.y = 625;
                ...
                function (mainWaterfallCallback) {
                  ...
                  async.waterfall([
                      ...
                      function (createGameWaterfallCallback) {
                        $http.get($scope.rootDir + "data/assets/multipleFisherman_floating.json")
                          .success(function (response) {
                      ...
                      function (createGameWaterfallCallback) {
                        ...
                        $http.get($scope.rootDir + "data/assets/multipleFisherman_hook.json")
                          .success(function (response) {
                      ...
                      function (createGameWaterfallCallback) {
                        ...
                        $http.get($scope.rootDir + "data/assets/multipleFisherman_achoice.json")
                          .success(function (response) {
                            ...
                            $scope.firstFish.addEventListener("pressup", function (event) {
                              if (!$scope.selectionInProgress) {
                                selectFish($scope.activityData.activeQuestionIndex, "aChoice", $scope.firstFish.x);
                              }
                            });
                      ...
                      function (createGameWaterfallCallback) {
                        $http.get($scope.rootDir + "data/assets/multipleFisherman_bchoice.json")
                          .success(function (response) {
                            ...
                            $scope.secondFish.addEventListener("pressup", function (event) {
                              ...
                              if (!$scope.selectionInProgress) {
                                selectFish($scope.activityData.activeQuestionIndex, "bChoice", $scope.secondFish.x);
                              }
                      ...
                      function (createGameWaterfallCallback) {
                        $http.get($scope.rootDir + "data/assets/multipleFisherman_cchoice.json")
                          .success(function (response) {
                            ...
                            $scope.thirdFish.addEventListener("pressup", function (event) {
                              ...
                              if (!$scope.selectionInProgress) {
                                selectFish($scope.activityData.activeQuestionIndex, "cChoice", $scope.thirdFish.x);
                              }
                            ...
                            $scope.answerCTextContainer.addEventListener("pressup", function (event) {
                              ...
                              if (!$scope.selectionInProgress) {
                                selectFish($scope.activityData.activeQuestionIndex, "cChoice", $scope.thirdFish);
                              }
                          ...
                          function (initWaterfallCallback) {
                            ...
                            $http.get($scope.rootDir + "data/assets/lesson_end_button_sprite.json")
                              .success(function (response) {
                                ...
                                $scope.resultsTotalContainer.addChild($scope.resultsButton);

                                $scope.endText = new createjs.Text("RESULTS", "25px Arial", "white");
                                $scope.endText.x = 450;
                                $scope.endText.y = 580;
                                $scope.endText.scaleY = $scope.endText.scaleX = 0.8;
                                $scope.resultsTotalContainer.addChild($scope.endText);
                          ...
                          function (createPageButtonsAndDescriptionCallback) {
                            ...
                            $http.get($scope.rootDir + "data/assets/next_activity_drag_and_drop_sprite.json")
                              .success(function (response) {
                                ...
                                $scope.resultsTotalContainer.addChild($scope.nextButton);
                                $scope.stage.update();
                                createPageButtonsAndDescriptionCallback(null);
                              })
                              .error(function (error) {
                              ...
                              function (resultsButtonsWaterfallCallback) {
                                ...
                                restartButtonImageLoader.on("complete", function (r) {
                                  ...
                                  $scope.restartButton.addEventListener("pressup", function (event) {
                                    $scope.nextButton.gotoAndPlay("normal");
                                    console.log("Click on restart button for question: ", $scope.activityData.activeQuestionIndex);
                                    $scope.activityData.questions[$scope.activityData.activeQuestionIndex].userAnswer = "";
                                    loadQuestion($scope.activityData.activeQuestionIndex);
                                  });
