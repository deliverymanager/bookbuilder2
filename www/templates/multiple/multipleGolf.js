  ...
  .controller("MultipleGolfController", function ($scope, $ionicPlatform, $timeout, $http, _, $state, $rootScope, $ionicHistory, Toast) {
    ...
    $timeout(function () {
      ...
      var imageLoader = new createjs.ImageLoader(new createjs.LoadItem().set({
        src: $rootScope.rootDir + "data/assets/golf_background_image.png"
      }));
      ...
      imageLoader.on("complete", function (r) {
        ...
        var background = new createjs.Bitmap($rootScope.rootDir + "data/assets/golf_background_image.png");
          ...
          async.waterfall([
              ...
              function (initWaterfallCallback) {
                ...
                createSoccerGameParallelFunctions.push(function (parallelCallback) {
                  $http.get($rootScope.rootDir + "data/assets/golf_ball.json")
                    .success(function (response) {
                ...
                createSoccerGameParallelFunctions.push(function (parallelCallback) {
                  $http.get($rootScope.rootDir + "data/assets/golf_boy_striking_sprite.json")
                    .success(function (response) {
                ...
                createSoccerGameParallelFunctions.push(function (parallelCallback) {
                  $http.get($rootScope.rootDir + "data/assets/golf_ball_splash.json")
                    .success(function (response) {
                    ...
                    $http.get($rootScope.rootDir + "data/assets/go_to_results_button_sprite.json")
                      .success(function (response) {
                        ...
                        $scope.goToResultsButton.addEventListener("mousedown", function (event) {
                          /*Active only when resultsContainer is invisble*/
                          if (!$scope.resultsContainer.visible) {
                          }
                        });
        ...
        function loadQuestion(questionIndex) {
          ...
          async.waterfall([
              ...
              function (loadQuestionWaterfallCallback) {
                ...
                /*$scope.formattedQuestionText = questionIndex + 1 + "." + $scope.activityData.questions[questionIndex].pretext
                  + "__________"
                  + ($scope.activityData.questions[questionIndex].midtext ? $scope.activityData.questions[questionIndex].midtext : "")
                  + $scope.activityData.questions[questionIndex].postext;

                $scope.questionText.text = $scope.formattedQuestionText;

                console.log("Question: ", $scope.questionText.text);*/
