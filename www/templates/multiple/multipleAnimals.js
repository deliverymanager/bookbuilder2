angular.module("bookbuilder2")
  .controller("MultipleAnimalsController", function ($scope, $ionicPlatform, $timeout, $http, _, $state, $rootScope, $ionicHistory, Toast) {
    ...
    $timeout(function () {
      ...
      var imageLoader = new createjs.ImageLoader(new createjs.LoadItem().set({
        src: $rootScope.rootDir + "data/assets/animals_background_image.png"
      }));
      ...
      imageLoader.on("complete", function (r) {
        ...
        var background = new createjs.Bitmap($rootScope.rootDir + "data/assets/animals_background_image.png");
        ...
        async.waterfall([function (callback) {
            ...
            $http.get($rootScope.rootDir + "data/assets/birds_choice_sprite.json")
              .success(function (response) {
