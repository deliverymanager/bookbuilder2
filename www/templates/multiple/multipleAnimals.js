angular.module("bookbuilder2")
  .controller("MultipleAnimalsController", function ($scope, $ionicPlatform, $timeout, $http, _, $rootScope, Toast) {
    ...
    var timeout = $timeout(function () {
      ...
      var imageLoader = new createjs.ImageLoader(new createjs.LoadItem().set({
        src: $scope.rootDir + "data/assets/animals_background_image.png"
      }));
      ...
      imageLoader.on("complete", function (r) {
        ...
        var background = new createjs.Bitmap($scope.rootDir + "data/assets/animals_background_image.png");
            ...
            function (callback) {
              ...
              $http.get($scope.rootDir + "data/assets/multiple_choice_choice_button_sprite.json")
                .success(function (response) {
                  ...
                  $scope.buttonChoicesText["dChoice"].maxWidth = $scope.buttonChoices["dChoice"].getBounds().width * 0.7;
          ...
          if (!$scope.activityData.newGame) {
            ...
            if (question.userAnswer === question.answerChoice) {
              ...
              if ($scope.activityData.questions[$scope.activeQuestionIndex].answerChoice === "cChoice") {
                ...
                $scope.buttonChoices[$scope.activityData.questions[$scope.activeQuestionIndex].answerChoice].gotoAndPlay("red");
              }

              if ($scope.activityData.questions[$scope.activeQuestionIndex].midtext) {
                var splittedText = $scope.activityData.questions[$scope.activeQuestionIndex][$scope.activityData.questions[$scope.activeQuestionIndex].answerChoice].split("...");
                $scope.firstGap.text = splittedText[0];
                $scope.secondGap.text = splittedText[1];
                $scope.firstGap.color = "black";
                $scope.secondGap.color = "black";
              } else {
                $scope.firstGap.text = $scope.activityData.questions[$scope.activeQuestionIndex][$scope.activityData.questions[$scope.activeQuestionIndex].answerChoice];
                $scope.firstGap.color = "black";
              }
        ...
        var positionQuestionText = function (question, key) {
          ...
          if ($scope.activityData.questions[key].midtext) {
            ...
            console.log("currentMidtexts", currentMidtexts)
