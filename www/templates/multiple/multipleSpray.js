            ...
            function (callback) {
              ...
              $http.get($scope.rootDir + "data/assets/spray_choice_button_sprite.json")
                .success(function (response) {
                  ...
                  $scope.buttonChoicesText["dChoice"].x = $scope.buttonContainers["dChoice"].width / 1.45;
                  ...
                  $scope.buttonChoicesText["cChoice"].maxWidth = $scope.buttonChoices["dChoice"].getBounds().width * 0.7;
                  ...
                  $scope.buttonChoicesText["onlyCChoice"].x = $scope.buttonContainers["onlyCChoice"].width / 1.68;
