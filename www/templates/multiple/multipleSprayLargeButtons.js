angular.module("bookbuilder2")
  .controller("MultipleSprayLargeButtonsController", function ($scope, $ionicPlatform, $timeout, $http, _, $rootScope, Toast) {

    console.log("MultipleSprayLargeButtonsController loaded!");
    ...
    var timeout = $timeout(function () {
      ...
      imageLoader.on("complete", function (r) {
        ...
        async.waterfall([function (callback) {
            ...
            _.each(["spray_choice_text_bubble.png", "lesson_yellow_line.png", "spray_large_choice_button_sprite.png", "yellow_line_big_bubble.png"], function (file, key, list) {
            ...
            function (callback) {
              ...
              $scope.buttonContainers["aChoice"].width = $scope.answersContainer.width;
              ...
              $scope.buttonContainers["bChoice"].width = $scope.answersContainer.width;
              $scope.buttonContainers["bChoice"].height = $scope.answersContainer.height / 3;
              $scope.buttonContainers["bChoice"].x = 0;
              ...
              $scope.buttonContainers["cChoice"].width = $scope.answersContainer.width;
              ...
              $http.get($scope.rootDir + "data/assets/spray_large_choice_button_sprite.json")
                .success(function (response) {
        ...
        var positionQuestionText = function (question, key) {
          ...
          var firstGap = "_____________________________________________";
          ...
          if ($scope.activityData.questions[key].midtext) {
            ...
            var secondGap = "_____________________________________________";
